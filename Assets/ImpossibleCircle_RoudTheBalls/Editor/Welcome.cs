...
public class Welcome : EditorWindow 
{
	...
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
	private const string ONLINE_DOC_URL = "https://dl.dropboxusercontent.com/u/8289407/ImpossibleCircleRoundTheBalls/Documentation/html/annotated.html";
	private const string RATEUS_URL = "http://u3d.as/rGG";

	private const string NAME_OF_THE_GAME = "IMPOSSIBLE CIRCLE - ROUND THE BALLS";
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
	/******* TO MODIFY **********/
